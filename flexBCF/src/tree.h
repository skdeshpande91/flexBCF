...
public:
  ...
  friend void read_tree(tree &t, std::string &tree_string, tree_prior_info &tree_pi, set_str_conversion &set_str);

  
  friend void grow_tree_mu(tree &t, suff_stat &ss_train, int &accept, double &sigma, data_info &di_train, tree_prior_info &tree_pi, RNG &gen);
  friend void grow_tree_tau(tree &t, suff_stat &ss_train, int &accept, double &sigma, data_info &di_train, tree_prior_info &tree_pi, RNG &gen);
  friend void prune_tree_mu(tree &t, suff_stat &ss_train, int &accept, double &sigma, data_info &di_train, tree_prior_info &tree_pi, RNG &gen);
  friend void prune_tree_tau(tree &t, suff_stat &ss_train, int &accept, double &sigma, data_info &di_train, tree_prior_info &tree_pi, RNG &gen);

  friend void update_tree_mu(tree &t, suff_stat &ss_train, int &accept, double &sigma, data_info &di_train, tree_prior_info &tree_pi, RNG &gen);
  friend void update_tree_tau(tree &t, suff_stat &ss_train, int &accept, double &sigma, data_info &di_train, tree_prior_info &tree_pi, RNG &gen);
